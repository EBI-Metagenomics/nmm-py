...
def test_hmmer_1(tmp_path):
    ...
    mu, lamb = (-5.4106, 0.77110)
    pv = hmmer.gumbel(most_likely_seq, mu, lamb)
    pv = hmmer.gumbel("ACDEFGHI", mu, lamb)
    pv = hmmer.gumbel("ACDEFGHI"[::-1], mu, lamb)
